...
public class CookbookManager extends CookbookManager_Base {
	...
	/**
	 * Folha de estilo a aplicar no site.
	 * 
	 * @return
	 */
	...
	public static String getMenu(String strOpcao, String search) {
		...
		strMenuHtml = strMenuHtml
				+ "<li class='createRecipe'><a href='/createRecipe'>Create Recipe</a></li>"
				+ "\n";
		strMenuHtml = strMenuHtml
				+ "<li class='recipes'><a href='/recipes'>List Recipes</a></li>"
				+ "\n";
		strMenuHtml = strMenuHtml
				+ "<li class='manageRecipes'><a href='/manageRecipes'>Manage Recipes</a></li>"
				+ "\n";
		strMenuHtml = strMenuHtml
		...
		strMenuHtml = strMenuHtml
				+ "<li class='searchClass'><div id='search' >" + "\n";
		if (!strOpcao.equals(""))
			strMenuHtml = strMenuHtml.replace("class='" + strOpcao + "'",
					"class='current_page_item'");
		strMenuHtml = strMenuHtml + "	<form method='post' action='search'>"
				+ "\n";
		strMenuHtml = strMenuHtml
				+ "		<input name='search' id ='search-text' value ='" + search
				+ "'></input>" + "\n";
		strMenuHtml = strMenuHtml
	...
	/**
	 * Função para Preparar Carregamentos predefinidos como o estilo, menu,
	 * titulo do site e autores.
	 * 
	 * @param model
